...
template <typename T> size_t Vector<T>::size() { return _size; }

template <typename T> bool Vector<T>::empty() { return _size == 0; }

template <typename T> Vector<T>::iterator Vector<T>::begin() { return _data; }
